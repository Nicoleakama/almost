...
fun BottomBar(navController: NavHostController) {
    ...
    BottomNavigation(elevation = 10.dp) {
        ...
        BottomNavigationItem(icon = {
            ...
            label = { androidx.compose.material.Text(text = "Favorite") },
            selected = navController.currentDestination?.route ==  ROUTE_SHOP,
            onClick = {
        ...
        BottomNavigationItem(icon = {
            ...
            selected = navController.currentDestination?.route ==  ROUTE_PRODUCTS,
            onClick = {
